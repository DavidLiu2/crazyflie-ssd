...
void Convolution39(
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      {
        DMA_copy_W.ext = dory_get_tile_3d(l2_W, _i_nof_load, 0, _i_nif_load, 16, 1*1, 48, 1*1, 48, 0,0,0,0,0,0, 8);
        DMA_copy_W.loc = (l1_buffer + 11216);
