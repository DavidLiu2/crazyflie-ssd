...
void Convolution69(
  ...
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 10344);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      {
        DMA_copy_W.ext = dory_get_tile_3d(l2_W, _i_nof_load, 0, _i_nif_load, 16, 3*3, 16, 3*3, 16, 0,0,0,0,0,0, 8);
        DMA_copy_W.loc = (l1_buffer + 8016);
    ...
    b = (uint8_t *) (l1_buffer + 10344 + _i_nof_load*64);
    W = (uint8_t *) (l1_buffer + 8016);
